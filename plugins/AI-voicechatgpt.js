...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  try {
      ...
      try {
        ...
        const replacementString2 = ' English ';
        const rres = await fetch(`https://api.ibeng.tech/api/others/chatgpt?q=Ciao&apikey=eMlBNRzUXv`);
      ...
      try {
        ...
        throw `https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q *[❗] 𝙴𝚁𝚁𝙾𝚁*`;
     }}
    }}
   }}
  }}
...
async function tts(text = 'error', lang = 'en') {
