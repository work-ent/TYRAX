...
const handler = async (m, {conn, usedPrefix, command}) => {
  ...
  if (!(who in global.db.data.users)) throw `https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q *[❗𝐈𝐍𝐅𝐎❗] The user still has to write a message*`;
  ...
  m.reply(`*[❗𝐈𝐍𝐅𝐎❗] Total Message* : *${user.messaggi}*`);
};
