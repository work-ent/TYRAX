...
const handler = async (m, {conn, text, __dirname, usedPrefix, command}) => {
  if (!global.db.data.chats[m.chat].modohorny && m.isGroup) throw 'https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q *[❗𝐈𝐍𝐅𝐎❗] The +18 commands are disabled in this group if you are admin and want to activate them use the command #enable horny mode*';
  if (!text) throw 'https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q *[❗] enter the name of some hentai to search*';
