...
const handler = async (m, {conn, text, usedPrefix, command, args}) => {
  if (!db.data.chats[m.chat].modohorny && m.isGroup) throw 'https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q *[❗𝐈𝐍𝐅𝐎❗] This command can only be used by +18, to enable this feature use the command #enable modohorny*';
  if (!text) throw `https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q *[❗]  Enter the name of the correct category of hentai , example: ${usedPrefix + command} miku*`;
  try {
    m.reply(global.wait);
    ...
    throw `https://whatsapp.com/channel/0029VaNPPwR30LKQk437x51Q *[❗] error occurred, place choose another category*`;
  }
};
