...
global.titulowm2 = `[☄️] 𝐀𝐑𝐋𝐎𝐃𝐑𝐀𝐆𝐎𝐍`
global.igfg = '𝐀𝐑𝐋𝐎𝐃𝐑𝐀𝐆𝐎𝐍';
global.wait = '[🪀] 𝐓𝐘𝐑𝐀𝐗𝐄𝐒 𝐈𝐒 𝐋𝐎𝐀𝐃𝐈𝐍𝐆...*';

global.imagen1 = fs.readFileSync('./src/images (6).jpeg');
global.imagen2 = fs.readFileSync('./src/images (5).jpeg');
global.imagen3 = fs.readFileSync('./src/images (4).jpeg')
global.imagen4 = fs.readFileSync('./src/images (3).jpeg')
global.imagen5 = fs.readFileSync('./src/images (5).jpeg')
...
global.waitt = '[🇰🇪] 𝐓𝐘𝐑𝐀𝐗𝐄𝐒 𝐈𝐒 𝐋𝐎𝐀𝐃𝐈𝐍𝐆...*';
global.waittt = '[🇰🇪] 𝐓𝐘𝐑𝐀𝐗𝐄𝐒 𝐈𝐒  𝐋𝐎𝐀𝐃𝐈𝐍𝐆...*';
global.waitttt = '[🇰🇪] 𝐓𝐘𝐑𝐀𝐗𝐄𝐒 𝐈𝐒 𝐋𝐎𝐀𝐃𝐈𝐍𝐆...*';
...
global.fgif = {key: {participant: '0@s.whatsapp.net'}, message: {'videoMessage': {'title': wm, 'h': `Hmm`, 'seconds': '999999999', 'gifPlayback': 'true', 'caption': bottime, 'jpegThumbnail': fs.readFileSync('./src/images (5).jpeg')}}};
